  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* SUHU CARD */}
        <div className="glass-card p-6 rounded-3xl bg-white border-sky-100 space-y-3 shadow-sm">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-sky-600">{suhuObjek.toFixed(1)}</span>
        ...
        {/* DETAK JANTUNG CARD */}
        <div className="glass-card p-6 rounded-3xl bg-white border-rose-100 space-y-3 shadow-sm">
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-rose-500">{bpm > 0 ? bpm : '--'}</span>
        ...
        <div className="glass-card p-6 rounded-3xl bg-gradient-to-br from-sky-50 to-indigo-50 border-sky-200 space-y-3 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs text-sky-800 font-bold flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-sky-600" /> Ringkasan Kesehatan
            </span>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-white hover:bg-sky-100 border border-sky-200 text-sky-700 font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all"
            >
      ...
      <div className="space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-3xl font-extrabold text-slate-900">Panduan Gaya Hidup Sehat Siswa</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* CATEGORY 1: HIDRASI */}
          <div className="glass-card p-6 rounded-3xl bg-white border-sky-100 space-y-4 shadow-md shadow-sky-500/5">
      ...
      <div className="p-8 rounded-3xl bg-gradient-to-r from-sky-500 via-sky-600 to-blue-600 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-sky-500/20 border border-sky-400/30">
        <div className="space-y-2 text-center md:text-left">
          <h3 className="text-xl font-black text-white">Ingin Catat Hasil Rekomendasi Ini?</h3>
        ...
        <Link
          href="/dashboard"
          className="px-8 py-3.5 rounded-full bg-white hover:bg-sky-50 text-sky-600 font-extrabold text-xs shadow-lg flex items-center gap-2 shrink-0 transition-all hover:scale-105"
        >
