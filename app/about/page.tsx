...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      {/* HERO SECTION */}
      <section className="glass-card p-8 sm:p-12 rounded-3xl bg-white border-sky-100 shadow-xl shadow-sky-500/5 text-center space-y-6 relative overflow-hidden">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-sky-100 text-sky-700 text-xs font-extrabold mx-auto">
        ...
        <div className="pt-2 flex flex-wrap justify-center items-center gap-2">
          <span className="text-xs font-bold text-slate-500 flex items-center gap-1.5">
            <GraduationCap className="w-4 h-4 text-sky-500" /> Sasaran Utama:
          </span>
          <span className="px-4 py-1.5 rounded-full bg-sky-50 border border-sky-200 text-sky-700 text-xs font-extrabold shadow-sm">
      ...
      {/* LATAR BELAKANG */}
      <section className="glass-card p-8 rounded-3xl bg-white border-sky-100 shadow-md space-y-4">
        <div className="flex items-center gap-2 text-sky-600 font-extrabold text-sm uppercase tracking-wider">
          <Award className="w-4 h-4 text-sky-500" /> Latar Belakang Pengembangan
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* VISI */}
        <div className="glass-card p-8 rounded-3xl bg-white border-sky-100 space-y-4 shadow-md flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <h3 className="text-2xl font-extrabold text-slate-900">Visi</h3>
        ...
        {/* MISI */}
        <div className="glass-card p-8 rounded-3xl bg-white border-sky-100 space-y-4 shadow-md">
      ...
      <section className="space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <h2 className="text-3xl font-extrabold text-slate-900">Fitur & Keunggulan Utama</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feat, i) => {
            ...
            return (
              <div key={i} className="glass-card p-6 rounded-3xl bg-white border-sky-100 space-y-3 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 text-sm">Kolaborasi tim yang mengembangkan EduWellness IoT Health Education</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="glass-card p-6 rounded-3xl bg-white border-sky-100 space-y-4 shadow-md flex flex-col justify-between relative overflow-hidden group">
              <div className="space-y-3">
      ...
      <section className="glass-card p-8 sm:p-10 rounded-3xl bg-white border-sky-100 space-y-6 shadow-md">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-2xl bg-sky-50 flex items-center justify-center text-sky-600 border border-sky-100">
            <Cpu className="w-5 h-5" />
          </div>
          <div>
            <h3 className="text-xl font-extrabold text-slate-900">Teknologi yang Digunakan</h3>
        ...
        <div className="flex flex-wrap gap-3">
          {techStack.map((tech, i) => (
            <div key={i} className="px-4 py-2 rounded-2xl bg-slate-50 border border-slate-200 text-slate-800 text-xs font-extrabold flex items-center gap-2 shadow-xs">
      ...
      {/* KONTAK & HAK CIPTA */}
      <section className="glass-card p-8 rounded-3xl bg-white border-sky-100 grid grid-cols-1 md:grid-cols-2 gap-8 items-center shadow-md">
        <div className="space-y-3">
          <h3 className="text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <Mail className="w-5 h-5 text-sky-500" /> Hubungi Kami
          </h3>
          ...
          <div className="space-y-1.5 pt-1">
            {contacts.map((email, i) => (
              <a 
                key={i} 
                href={`mailto:${email}`}
                className="block text-xs font-bold text-sky-600 hover:text-sky-700 transition-colors"
              >
                ✉️ {email}
              </a>
            ))}
        ...
        <div className="p-6 rounded-2xl bg-sky-50 border border-sky-100 text-center space-y-2">
          <span className="text-xs font-extrabold text-sky-700 tracking-wider uppercase">Hak Cipta</span>
          <div className="text-2xl font-black text-slate-900">© 2026 EduWellness</div>
